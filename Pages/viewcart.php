...
$resultp=$obstock->viewStockPrice
        ...
        $rowp=$resultp->fetch(PDO::FETCH_BOTH);
                        ...
                        <tr>
                            ...
                            <td>
                <a href="editcart.php?order_id=<?php echo $order_id; ?>
               &item_id=<?php echo $item_id; ?>
               &color_id=<?php echo $rowcart['color_id']; ?>
               &size_id=<?php echo $rowcart['size_id']; ?>&qsum= <?php echo $rowcart['qsum']; ?>&totalprice= <?php echo $rowcart['cpsum']; ?>">Edit        
                                </a>
                                
<!--                                <a href="../Controllers/Controllers.php?action=delcart
                                   &order_id=<?php //echo $order_id; ?>
               &item_id=<?php //echo $item_id; ?>
               &color_id=<?php //echo $rowcart['color_id']; ?>
               &size_id=<?php //echo $rowcart['size_id']; ?>">Delete        
                                </a>
                             -->
  ...
  <a href="<?php echo $u; ?>?status=<?php echo $status ?>">
