...
$resultn = $obcus->viewAllOCustomer();
...
$limit = 5;
$result = $obcus->viewCustomerOLimited($start, $limit);
$uni_id = time() . "_" . date();
                ...
                <div class="row" style="padding-top:  px">
                    ...
                    <div class="col-md-8 col-sm-6" style="text-align: right">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Online Customers</li>
                        </ol>
            ...
            <div id="contents">
                ...
                <div class="row">
                    <div   class="col-md-12 col-sm-6" style="background: linear-gradient(lightgray,#ffffff)">
                        <h3  style="padding-top: 5px" class="alig">Online Customers</h3>
                    </div>
                </div>
                            ...
                            <table class="table table-responsive table-hover table-striped">
                                ...
                                while ($row = $result->fetch(PDO::FETCH_BOTH)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $rowdis['city_name']; ?></td>
                            ...
                            <center>
                                <nav class="container">
                                    <ul class="pagination pagination-sm">
                                        ...
                                        for ($i = 1; $i <= $nop; $i++) {
                                            ?>
                                            <li><a href="../view/customeronline.php?page=<?php echo $i; ?>"> <?php echo $i; ?></a></li>
                                        <?php } ?>                                
                                    </ul>                            
                                </nav>
                            </center>
