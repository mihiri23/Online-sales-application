        ...
        <div id="contents">
               ...
               <form >
                    <div class="row">
                            ...
                            <div class=" col-md-offset-1 col-md-5 " style="text-align: right">
                                <div class="col-md-3"><p style="color: brown; text-decoration: solid;" >Customer ID</p></div>
                                <div class="col-md-2"><input type="label" name="cus_id" id="cus_id" value="<?php echo $cus_id;?>" class="form-control"/>
                                    
                                </div>
                            </div>
                            
                        <div class="col-md-6" style="text-align: left">
                                <div class="col-md-3"><p style="color: brown; text-decoration: solid;">Customer Name</p></div>
                                <div class="col-md-3"><input type="label" name="cus_name" id="cus_name" value="<?php echo $rowcus['cus_name'];?>" class="form-control" />
                ...
                <div class="row">
                    <div   class="col-md-12 col-sm-6" style="background: linear-gradient(lightgray,#ffffff)">
                        <h2  style="padding-top: 15px" class="alig">Order Items</h2>
                    </div>
                </div>
                <div class="clearfix">&nbsp;</div>
                <div class="clearfix">&nbsp;</div>
                        ...
                        <table class="ui celled table" id="example">
                            ...
                            <?php while($row=$result->fetch(PDO::FETCH_BOTH)){ 
                               ...
                               foreach ($arr as $v){
                                ...
                                ?>
                            <tr>
                                <td><img src="<?php echo $path; ?>" height="40" /></td>
                                ...
                                <td>
                                    <a href="../view/addaorder.php?cus_id=<?php echo $cus_id; ?>& item_id=<?php echo $row['item_id']; ?>&uni_id=<?php echo $uni_id; ?>&order_id=<?php echo $_REQUEST['order_id'];?>">
                                    <button type="button" 
