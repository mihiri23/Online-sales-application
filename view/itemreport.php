    ...
    var revenueChart = new FusionCharts(
        ...
        dataSource: {
            "chart": {
                ...
                "subCaption": "Monthly Analysis ",
                "xAxisName": "Month",
                "yAxisName": "Order Quantity",
            
                "paletteColors": "#f0ad4e",
                "bgColor": "#ffffff",
                "borderAlpha": "20",
                "canvasBorderAlpha": "0",
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-6" style="text-align: right">
                        <ol class="breadcrumb">
                            ...
                            <li><a href=""> Current Year Online Order Details by Month</a></li>
                        </ol>
                ...
                <div class="row">
                  <?php include '../common/modules.php'; ?>
                    <div class="col-md-9 col-sm-8">
                        <h3> Current Year Online Order Details by Month</h3>
                  ...
                  <?php include '../common/modules.php'; ?>
                    <div class="col-md-9 col-sm-8">
                        <h3> Current Year Internal Order Details by Month</h3>
